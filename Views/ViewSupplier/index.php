  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?= $supplier->className() ?></h1>
      </div>

      <a href="./create.php"><button type="button" class="btn btn-primary mb-2">+ Tambah Supplier</button></a>
        ...
        <table class="table table-striped table-lg">
          <thead>
            <tr>
              ...
              <th scope="col" class="align-mid">Nama Supplier</th>
          ...
          <tbody>
            <?php while($row = mysqli_fetch_array($data)) { ?>
              <tr>
                ...
                <th class="font-normal"><?= $row['nama_supplier']?></th>
                <th class="font-normal"><?= $row['no_hp']?></th>
                <th class="font-normal"><?= $row['alamat']?></th>
                <th class="font-normal"><?= $row['id_pembelian']?></th>
                <th>
                    <a href="./edit.php?id_supplier=<?= $row['id_supplier']?>"><button type="button" class="btn btn-warning">Edit</button></a>
