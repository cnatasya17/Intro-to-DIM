  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?= $pelanggan->className()?></h1>
      </div>

      <a href="./create.php"><button type="button" class="btn btn-primary mb-2">+ Tambah Pelanggan</button></a>
          ...
          <tbody>
            <?php while($row = mysqli_fetch_array($data)) { ?>
              ...
              <th style="display: flex;">
                <a href="./edit.php?id_pelanggan=<?=$row['id_pelanggan']?>"><button type="button" class="btn btn-warning">Edit</button></a>
