  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create <?= $penjualan->className() ?></h1>
      </div>
      ...
      <form action="?action=store" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control w-50" name="jumlah_penjualan" id="jumlah_penjualan" placeholder="4">
        </div>

        <div class="mb-3">
            <label for="harga_jual" class="form-label">Harga Jual</label>
            <input type="number" class="form-control w-50" name="harga_jual" id="harga_jual" placeholder="5200">
        </div>

        <div class="mb-3">
            <label for="id_barang" class="form-label">Id Barang</label>
            <input type="text" class="form-control w-50" name="id_barang" id="id_barang" placeholder="BRG6">
        </div>
