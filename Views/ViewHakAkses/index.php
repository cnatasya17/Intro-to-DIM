<?php
    ...
    require_once '../../Classes/HakAkses.php';
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#"><?= $hakakses->className()?></a>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?= $hakakses->className() ?></h1>
      </div>

      <a href="./create.php"><button type="button" class="btn btn-primary mb-2">+ Tambah Hak Akses</button></a>
        ...
        <table class="table table-striped table-lg">
          <thead>
            <tr>
              ...
              <th scope="col" class="align-mid">Nama Akses</th>
          ...
          <tbody>
            <?php while($row = mysqli_fetch_array($data)) { ?>
              <tr>
                ...
                <th class="font-normal"><?= $row['nama_akses']?></th>
                <th class="font-normal"><?= $row['keterangan']?></th>
                <th>
                    <a href="./edit.php?id_akses=<?= $row['id_akses'] ?>"><button type="button" class="btn btn-warning">Edit</button></a>
