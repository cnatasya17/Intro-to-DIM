  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create <?= $hakakses->className() ?></h1>
      </div>

      <form action="?action=store" method="POST">
        <div class="mb-3">
            <label for="id_akses" class="form-label">Id Akses</label>
            <input type="text" class="form-control w-50" name = "id_akses" id="id_akses" placeholder="Cust1">
        </div>

        <div class="mb-3">
            <label for="nama_akses" class="form-label">Nama Akses</label>
            <input type="text" class="form-control w-50" name = "nama_akses" id="nama_akses" placeholder="Customer">
        </div>

        <div class="mb-3">
            <label for="keterangan" class="form-label">Keterangan</label>
            <input type="text" class="form-control w-50" name = "keterangan" id="keterangan" placeholder="Pelanggan Toko">
        </div>
