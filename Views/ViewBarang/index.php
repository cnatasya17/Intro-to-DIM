  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?= $barang->className() ?></h1>
      </div>

      <a href="./create.php"><button type="button" class="btn btn-primary mb-2">+ Tambah Barang</button></a>
        ...
        <table class="table table-striped table-lg">
          <thead>
            <tr>
              ...
              <th scope="col" class="align-mid">Nama Barang</th>
              <th scope="col" class="align-mid">Keterangan</th>
              <th scope="col" class="align-mid">Satuan</th>
          ...
          <tbody>
            <?php while($row = mysqli_fetch_array($data)) { ?>
              <tr>
                ...
                <th class="font-normal"><?= $row['nama_barang'] ?></th>
                <th class="font-normal"><?= $row['keterangan'] ?></th>
                <th class="font-normal"><?= $row['satuan'] ?></th>
                <th class="font-normal"><?= $row['id_pengguna'] ?></th>
              
                <th style="display: flex;">
                  <a href="./edit.php?id_barang=<?= $row['id_barang'] ?>"><button type="submit" class="btn btn-warning">Edit</button></a>
